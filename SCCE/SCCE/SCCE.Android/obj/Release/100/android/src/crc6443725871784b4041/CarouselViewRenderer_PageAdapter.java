...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CarouselView.FormsPlugin.Android.CarouselViewRenderer+PageAdapter, CarouselView.FormsPlugin.Android", CarouselViewRenderer_PageAdapter.class, __md_methods);
	}
	...
	public CarouselViewRenderer_PageAdapter ()
	{
		...
		if (getClass () == CarouselViewRenderer_PageAdapter.class)
			mono.android.TypeManager.Activate ("CarouselView.FormsPlugin.Android.CarouselViewRenderer+PageAdapter, CarouselView.FormsPlugin.Android", "", this, new java.lang.Object[] {  });
	}
